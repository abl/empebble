...
emcc $@ -O0 -o ../build/www/compiled.js \
	...
	-s EXPORTED_FUNCTIONS="['_create_dict', '_add_bytes_to_dict', '_add_string_to_dict', '_add_uint8_to_dict', '_add_uint16_to_dict', '_add_uint32_to_dict', '_add_int8_to_dict', '_add_int16_to_dict', '_add_int32_to_dict', '_send_dict_to_pebble', '_press_back', '_press_up', '_press_select', '_press_down', '_release_back', '_release_up', '_release_select', '_release_down', '_main']" \
